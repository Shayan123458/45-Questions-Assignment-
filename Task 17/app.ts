...
console.log(`Sorry! ${Guest[6]} I Cannot Invite You For Dinner!!`);
Guest.pop()
console.log(Guest)
console.log(`Sorry! ${Guest[5]} I Cannot Invite You For Dinner!!`);
Guest.pop()
console.log(Guest)
console.log(`Sorry! ${Guest[4]} I Cannot Invite You For Dinner!!`);
Guest.pop()
console.log(Guest)
console.log(`Sorry! ${Guest[3]} I Cannot Invite You For Dinner!!`);
Guest.pop()
console.log(Guest)
console.log(`Sorry! ${Guest[2]} I Cannot Invite You For Dinner!!`);
Guest.pop()
console.log(Guest)
console.log (`Mr ${Guest[0]} And Mr ${Guest[1]} You Both Are Still Invited For A Dinner!!`)
Guest.pop()
console.log(Guest)
Guest.pop()
console.log(Guest)
